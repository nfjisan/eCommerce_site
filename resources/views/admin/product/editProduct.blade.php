        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    <h3>Edit Products
                        <a href="{{ url('admin/product') }}" class="btn btn-warning float-end">Back</a>
                    </h3>
                </div>
                <div class="card-body">
                    @if ($errors->any())
                        ...
                        <ul class="nav nav-tabs" id="myTab" role="tablist">
                            ...
                            <li class="nav-item" role="presentation">
                                <button class="nav-link" id="image-tab" data-bs-toggle="tab"
                                    ...
                                    aria-controls="image-tab-pane" aria-selected="false">Prducts
                                    Image</button>
                            </li>
                            <li class="nav-item" role="presentation">
                                <button class="nav-link" id="color-tab" data-bs-toggle="tab"
                                    data-bs-target="#color-tab-pane" type="button" role="tab"
                                    aria-controls="color-tab-pane" aria-selected="false">Prducts
                                    Color</button>
                            </li>
                        </ul>
                        <div class="tab-content" id="myTabContent">
                            <div class="tab-pane fade border p-3 show active" id="home-tab-pane" role="tabpanel"
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea name="small_des" class="form-control" rows="4">{{ $product->small_des }}</textarea>
                                </div>
                                <div class="mb-3">
                            ...
                            <div class="tab-pane fade border p-3" id="seotag-tab-pane" role="tabpanel"
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea name="meta_des" class="form-control" rows="4">{{ $product->meta_des }}</textarea>
                                </div>
                                <div class="mb-3">
                            ...
                            <div class="tab-pane fade border p-3" id="color-tab-pane" role="tabpanel"
                                ...
                                <div class="mb-3">
                                    ...
                                    <label for="">Select Colors</label><br /><br />
                                    <div class="row">
                                                ...
                                                <tr class="pdct-color-tr">
                                                    ...
                                                    <td>
                                                        <div class="input-group mb-3" style="width: 150px;">
                                                            <input type="text" value="{{ $pColor->quantity }}"
                                                                class="pdctColorQntity form-control form-control-sm">
                                                            <button type="submit"
                                                                class="updateColorBtn btn btn-primary btn-sm text-white"
                                                                value="{{ $pColor->id }}">Update</button>
                                                        </div>
                                                    </td>
                                                    <td>
                                                        <button type="submit"
                                                            class="deleteColorBtn btn btn-danger btn-sm text-white"
                                                            value="{{ $pColor->id }}">Delete</button>
                                                    </td>
                                                </tr>
                                            @endforeach
                                        </tbody>
    ...
    <script>
        $(document).ready(function() {
            ...
            $(document).on('click', '.updateColorBtn', function() {
                ...
                var prdct_color_id = $(this).val();
                var quantity = $(this).closest('.pdct-color-tr').find('.pdctColorQntity').val();
                ...
                $.ajax({
                    type: "POST",
                    url: "/admin/product-color/" + prdct_color_id,
                    data: data,
            ...
            $(document).on('click', '.updateColorBtn', function() {
                ...
                $ajax({
                    type: "GET",
                    url: "/admin/product-color/" + prdct_color_id + "/delete",

                    success: function(response) {
                        thisClick.closest('.pdct-color-tr').remove();
                        alert(response.message);
                    }
                });
            });
